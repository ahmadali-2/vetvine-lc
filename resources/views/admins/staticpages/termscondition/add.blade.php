    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div id="pay-invoice">
                    <div class="card-body">
                        <form action="{{ route('TermsCondition.create.db') }}" method="post" id="terms-form"
                            novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group" style="width: 100%;">
                                        <label for="page_title" class="control-label mb-1">Terms & Conditions
                                            Title</label>
                                        <input id="page_title" placeholder="Enter Title" name="page_title"
                                            value="{{ isset($terms->page_title) ? $terms->page_title : '' }}"
                                            name="page_title" type="text" class="form-control" value="" required>
                                        @error('page_title')
