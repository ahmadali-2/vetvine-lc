                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="banner_image_url" class="control-label mb-1">Advertisement
                                            Media Url</label>
                                        <input id="banner_image_url" placeholder="https://example.com" pattern="https://.*"
                                            name="banner_image_url" type="url" class="form-control" aria-required="true"
                                            aria-invalid="false" value="{{ $ad->banner_image_url }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input id="admedia" name="ad_media_update" accept='image/*' type="file"
                                            class="form-control cc-number identified visa" value="{{ $ad->ad_media }}">
