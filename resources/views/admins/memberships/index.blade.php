...
<section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a class="btn btn-primary float-right" style="background-color:#f27222" href="{{ route('membership.create') }}">
                        Add New Plan
                    </a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="content text-center">
            ...
            <div class="hover_content">
              <a href="{{route('membership.edit',$plan->id)}}" class="btn action-btns"
