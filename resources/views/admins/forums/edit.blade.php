                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="forum_title" placeholder="Enter Title" name="forum_title" type="text"
                                        class="form-control" aria-required="true" aria-invalid="false" value="{{$forum->forum_title}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select id="category_id" name="category_id" aria-label="Default select example"
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" @if($category->id == $forum->category_id) selected @endif>{{ $category->category_title }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="forum_description" rows="3"
                                        name="forum_description" value="">{{$forum->forum_description}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
