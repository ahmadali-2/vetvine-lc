                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="select_form" class="control-label mb-1 form-select">Select Category Or Forum</label>
                            ...
                            <form action="{{ route('forums.store') }}" method="post" id="forumform"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input id="forum_title" placeholder="Enter Title" name="forum_title"
