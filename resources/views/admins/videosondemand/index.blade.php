                           ...
                           <table class="table">
                               ...
                               <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td> <a href="{{ route('videos-on-demand.edit',$video->id) }}"><i class="fas fa-edit text-primary"></i></a>
                                        <a href="javascript:void(0)" id="editCompany" class="video" data-id="{{ $video->id }}"><i class="far fa-eye text-info"></i></a>
                                        {{-- <a href="{{route('videos-on-demand.show', $video->id)}}"> <i class="far fa-eye text-info"></i></a> --}}
                                        <a href="javascript:void(0);" class="text-decoration-none" onclick="deleteRecord('{{$video->id}}', '/superadmin/videos-on-demand/')">
            ...
            <div class="modal-body">
                <div class="col-12">
                    <div class="video-box">
                        ...
                        <iframe class="embed-responsive-item" id="videolink" src="" allowfullscreen></iframe>
                       </div>
                     {{-- <div class="embed-responsive embed-responsive-16by9">
