                    ...
                    <div class="generic_layout_left">
                        ...
                        <div class="quicky-link">
                            <div class="user-link">
                                <ul>
                                    <li>
                                        <div class="icon"><img src="{{ asset('frontend/img/search.png') }}"
                                                alt=""></div>
                                        Browse Members
                                    </li>
                                    <li>
                                        <div class="icon"><img src="{{ asset('frontend/img/invite.png') }}"
                                                alt=""></div>
                                        Invite your Colleagues
                                    </li>
                                    <li>
                                        <div class="icon"><img src="{{ asset('frontend/img/socialdna.png') }}"
                                                alt=""></div>
                                        My Social DNA
                                    </li>
                                    <li>
                                        <div class="icon" style="margin-left: 5px;"><a
                                                href="{{ route('userdashboard') }}">My Profile</a></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <ul>
                                <li>
                                    <div class="list-details">
                                        <div class="img"><img src="{{ asset('frontend/img/upcoming-ce.jpg') }}"
                                                alt=""></div>
                                        <div class="description">
                                            <p>Common and uncommon diseases in horses t..</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
