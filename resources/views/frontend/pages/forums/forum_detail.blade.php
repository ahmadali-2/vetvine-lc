                ...
                <div class="chat-box-a col-lg-12 pl-0 pr-0 d-flex">
                    <div class="user-pro-detail col-lg-8 col-md-10 col-sm-12">
                        <div class="user-pro ">
                            <div class="left-pro d-flex">
                                <div class="comment_forum  pr-1"><img src="{{ asset('frontend/forums/img/user.png') }}" alt=""></div>
                                <p class="mb-0 pl-2 pr-2">Admin</p>
                                <div class="comment_forum pl-1 "><img src="{{ asset('frontend/forums/img/crown.png') }}" alt=""></div>
                            </div>
                            <div class="date-icon d-flex align-items-center">
                                <div class="comment_forum"><span>Nov 22, 2021</span></div>
                                <div class="comment_forum pl-1 "><img src="{{ asset('frontend/forums/img/dots.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="chat-details">
                            ...
                            <div class="text-detail">
                                <div class="emajo"><img src="{{ asset('frontend/forums/img/smile.png') }}" alt="">
                                    <p>Gif</p>
                                </div>
                    ...
                    <div class="chat-side col-lg-4 col-md-2  pl-0 pr-0">
                        <div class="chat-side-detail">
                            ...
                            <div class="comment_forum  d-flex align-items-center"><img src="{{ asset('frontend/forums/img/view.png') }}" alt="">
                                <div class="chat-veiw">16 views</div>
                            </div>
                            <div class="comment_forum  d-flex align-items-center"><img src="{{ asset('frontend/forums/img/message.png') }}" alt="">
                                <div class="chat-veiw">0 comments</div>
                            </div>
                        </div>
                            <div class="similar">
                                <h4>Similars Post</h4>
                                <p>Ear Problem Post 1</p>
                                <p>Ear Problem Post 2</p>
                                <p>Ear Problem Post 3</p>
                            </div>
                        </div>
                    </div>
                </div>
