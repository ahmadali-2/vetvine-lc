        ...
        <div class="col-sm-12 text-left">
            ...
            <ol>
                ...
                <li>
                    ...
                    <br>
                    Please remember that medical information provided by PVS, in the absence of a visit with a veterinary health care professional, must be considered as an educational service only. The information sent through e-mail should not be relied upon as a medical consultation. This mechanism is not designed to replace a veterinarian's independent judgment about the appropriateness or risks of a diagnostic course, procedure and/or treatment for a given patient. We will do our best to provide you with information that will help you make your own health care decisions.
                ...
                <li>
                    ...
                    <br>
                    This telemedicine behavior consultation service is an extension of the primary care veterinarian's practice. In order for us to proceed in providing the consultation, the primary care veterinarian must consent to fully participate and the pet owner must consent to sharing of the pet's medical information.
                    <br>
              ...
              ALTHOUGH OUR HEALTH INFORMATION CONTENT IS REVIEWED AND APPROVED BY LICENSED VETERINARY PROFESSIONALS, PVS DOES NOT GUARANTEE THE ACCURACY, ADEQUACY, OR COMPLETENESS OF ANY INFORMATION AND IS NOT RESPONSIBLE FOR ANY ERRORS OR OMISSIONS OR FOR THE RESULTS OBTAINED FROM THE USE OF SUCH INFORMATION.
                ...
                <li>
                  <strong>  Applicable Law and Venue.</strong> By using the PVS website, either as a Guest or a Member, you agree to be bound by these Terms and Conditions, which shall be governed and interpreted solely in accordance with the substantive law of the State of New York (without regard to that State's conflict of laws) and the Federal laws of the United States (if applicable). Users of the PVS website further agree that any dispute or claim concerning advertising submitted hereunder shall be exclusively litigated in a state or federal court having competent jurisdiction in New York county, which PVS website users agree shall have personal jurisdiction over them. You agree that regardless of any law or statute to the contrary, any claim or cause of action arising out of or relating to the Web site and these Terms of Service must be filed within one (1) year of the date the cause of action arose, or be barred as untimely.
                </li>
                <li>
