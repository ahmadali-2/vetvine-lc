    ...
    <div class="payment-method-form">
        <div class="billing-info">
            ...
            <div class="credit-card-details">
                ...
                <form action="{{ route('payementwebinars') }}" method="POST" class="require-validation"
                    data-cc-on-file="false" data-stripe-publishable-key="pk_test_51HYPbbCsVtSxdbpXl6AFhtDvs9NlBiAoHATnsahYJOeroS1i1v0adtkqavK40tU5DGIANSi4z45elGhm1USEviSs00ELwmwof4" id="payment-form">

                    @csrf
                    <input type="hidden" value="@isset($video)
                       {{ $video }}
                    @endisset" name="video">
                    <input type="hidden" value="@isset($category_id)
                    {{ $category_id }}
                    @endisset" name="category_id">
                    ...
                    <div class="name-feild">
                        <div class="fname">
                            ...
                            <input autocomplete='off' name="cvc_number" placeholder='ex. 311' size='4'
                                type='text' id="cvc" class='form-control card-cvc'>
                        </div>
                    </div>
