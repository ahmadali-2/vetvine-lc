        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 line_member_box">
                    ...
                    <img src="{{ asset('frontend/images/sep-line-3.jpg') }}" width="150" height="2"
                        class="mrargine_sep_line" alt="">
                ...
                <div class="col-md-12 col-lg-6 ptg_meber_rightbox">
                    <img src="{{ asset('frontend/images/BECOME-2.png') }}" class="mm-top-margin" width="90"
                        height="41" alt="">
        ...
        <div class="container">
            <div class="mm-grow-new">
                <div class="grow_banner_box">
                    ...
                    <img src="{{ asset('frontend/images/sep-line-2.jpg') }}" width="250" height="2"
                        alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 line_member_box2">
                    <img src="{{ asset('frontend/images/thrive-icon.png') }}" width="86" height="83"
                        alt="">
                ...
                <div class="col-md-6 ptg_meber_rightbox">
                    <img src="{{ asset('frontend/images/thrive-icon2.png') }}" width="136" height="90"
                        alt="">
                    ...
                    <div class="popup-body">
                        <div class="row">
                            ...
                            <form method="POST" action="{{ route('verification.send') }}">
                                    @csrf
                                <div class="flex items-center justify-center mt-4 ">
                                    <x-jet-button type="submit" style="margin-left: 20%; background:#f27222;">
                                        {{ __('Resend Verification Email') }}
                                    </x-jet-button>
                                </div>
                            </form>
