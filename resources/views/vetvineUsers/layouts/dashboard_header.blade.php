      ...
      <div class="container">
        <div class="top-social">
          <ul class="list__icons dash-top-list">
            ...
            <li class="logout">
              <a href="#" class="toggle-contact" ><span class="mail-logo"></span> LogOut</a>
            </li>
      ...
      <div class="container">
        <nav class=" bg-header navbar navbar-expand-md" style="margin-top: -45px;">
          ...
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
            ...
            <span class="navbar-toggler-icon"><img src="{{ asset('frontend/img/menu-icon.png') }}" width="25" height="18" alt=""></span>
          </button>
            ...
            <ul class="navbar-nav nav-wrapper-one edit-profile-list">
              ...
              <li class="nav-item nav_res_3" style="text-align: center">
                ...
                <div class="dropdown" style="padding: 0px 10px 0px 10px ">
                  <a class="btn btn-primary dropdown-toggle btn-ce padding_top_0" type="button" data-toggle="dropdown">
                    <i class="employe"><img src="{{ asset('frontend/img/profile-pic.png') }}" style="width:30px;"></i><br>
                    Me
                    ...
                    <li class="mb-4">
                      <div class="content">
                        ...
                        <div class="content_box">
                                      <b>Sheri Berger</b>
                                      <a href="{{ route('vetvineUserProfile') }}" class="view_profile">View Your Profile</a>
                        </div>
                      </div>
                    </li>
              ...
              <li class="nav-item" style="text-align: center">
                ...
                <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle btn-ce" type="button" data-toggle="dropdown">
                    <i class="my-ce"><img src="{{ asset('frontend/img/featured-video-icon.png') }}" style="width:35px;"></i><br>
                    My CE
