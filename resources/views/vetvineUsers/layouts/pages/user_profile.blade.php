      ...
      <div class="col-12 col-sm-12 col-lg-9 col-xl-10 tab-content">
                    ...
                    <div class="inner-input">
                      ...
                      <select class="form-control" name="usernetwork" id="usernetwork">
                        ...
                        @if(isset(Auth::user()->network_id ) && Auth::user()->network_id  == $usernetwork->id)
                              <option value='{{$usernetwork->id }}' selected>{{$usernetwork->name}}</option>;
                            @else
                            <option value="{{ $usernetwork->id }}">{{ $usernetwork->name }}</option>
                            @endif
                        @endforeach
                    </select>
            ...
            <div class="row no-gutters">
              <div class="col-md-9 profile">
                ...
                <div class="general-area">
                  ...
                  <div class="serch-section">
                    <div class="inner-input">
                      ...
                      <input type="email" name="email" id="email" readonly value="{{Auth::user()->email ?? ''}}" placeholder=""  class="form-control" />
                ...
                <span class="asteric" id ="error11"></span>
                  ...
                  <div class="button col-sm-12 text-center"><button type="button" id="employe_btn" class="btn btn-Continue">Save & Continue</button></div>
                </div>
        ...
        <div class="tab-pane" id="tabs-3">
          ...
          <div class="general-area">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <img src="@if(Auth::user()->profile_photo) {{ asset('/frontend/images/Profile-Images/'.Auth::user()->profile_photo)}} @else {{asset('frontend/images/thumbnail.jfif')}} @endif" alt="" id="user-image" height="200px"> <br>
          ...
          <div class="button col-sm-12 text-center"><button type="submit" class="btn btn-Continue">Update Profile</button></div>
      </div>
        </div>
