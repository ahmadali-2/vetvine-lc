                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card m-0">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9 bg-white border border-light">
                                ...
                                <div class="chat-container">
                                    ...
                                    <div class="btn_parent text-right my-3">
                                      <button class="btn btn-primary send_msg_btn">Send Message</button>
                                    </div>
                                </div>
                            </div>
                        </div>
