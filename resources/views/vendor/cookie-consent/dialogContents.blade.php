                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="description">We use cookies to treat you to the best experience possible and
                                    ...
                                    <button class="confirm js-cookie-consent-agree cookie-consent__agree cursor-pointer flex items-center justify-center px-4 py-2 rounded-md text-sm font-medium text-yellow-800 bg-yellow-400 hover:bg-yellow-300">
                                        {{ trans('cookie-consent::texts.agree') }}
                                    </button>
