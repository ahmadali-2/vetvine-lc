    ...
    public function store(Request $request)
    {
        ...
        try{
            Event::create([
                ...
                "sponser_one"                   =>   $input['sponser_one'],
                "sponser_two"                   =>   $input['sponser_two'],
                "sponser_three"                 =>   $input['sponser_three'],
                "date"                          =>   $input['date'],
                "time"                          =>   $input['time'],
                "presenter_one"                 =>   $input['presenter_one'],
                "presenter_one_url"             =>   $input['presenter_one_url'],
                "presenter_two"                 =>   $input['presenter_two'],
                "presenter_two_url"             =>   $input['presenter_two_url'],
                "presenter_three"               =>   $input['presenter_three'],
