...
class CreateContinueEducationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'sponser_one'                        => ['required','string'],
            'sponser_two'                        => ['required','string'],
            'sponser_three'                      => ['required','string'],
            'date'                               => ['required'],
            'time'                               => ['required'],
            'presenter_one'                      => ['required','string'],
            'presenter_one_url'                  => ['required'],
            'presenter_two'                      => ['required','string'],
            'presenter_two_url'                  => ['required'],
            'presenter_three'                    => ['required','string'],
            'presenter_three_url'                => ['required'],
            'event_description'                  => ['required'],
            'main_photo'                         => ['required','image' ,'mimes:jpeg,png,jpg,gif,svg'],
